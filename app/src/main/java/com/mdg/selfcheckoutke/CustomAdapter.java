...
public class CustomAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            holder.title = vi.findViewById(R.id.list_view_name_text);
            holder.quantity=vi.findViewById(R.id.list_view_qty);
            holder.price= vi.findViewById(R.id.list_view_row_price);
